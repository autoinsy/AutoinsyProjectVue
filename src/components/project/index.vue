            ...
            <div class="mc">
              <ul>
                <li class="" v-for="news in newsList">
                  <span>
                    <router-link :to='{path: "/NewsDetails", query: {newsId: news.newsID}}'>[{{news.content}}]</router-link>
                    <router-link :to='{path: "/NewsDetails", query: {newsId: news.newsID}}'>{{news.newsTitle}}</router-link>
                  </span>
                </li>
              </ul>
            </div>
