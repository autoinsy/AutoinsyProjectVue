  ...
  return function (e) {
    ...
    l.deduplicate = function (e) {
      ...
      return t.forEach(function (t) {
        t && t.forEach(function (t) {
          -1 !== (r = l.findObjIndexInArray(e, {keyPath: s, value: a(t, s)})) ? e[r] = l.merge({}, e[r], t) : e.push(t)
        })
    ...
    (function (e) {
      ...
      t.getGlobal = o, t.detectCSSFeature = function (e) {
        ...
        return "error" === v(e)
      }, t.isnull = k, t.notnull = P, t.undef = I, t.notundef = C, t.exist = O, t.notexist = w, t.isObject = x, t.isEmpty = function (e) {
        return w(e) || (b(e) || M(e)) && 0 === e.length
        ...
        try {
          U(t) && (t = JSON.parse(t)), x(t) && j(t, function (n, r) {
            switch (v(r)) {
              case"string":
              case"object":
                t[n] = e(r)
      ...
      function D(e, t, n) {
        ...
        return j(e, function (e, t) {
          T(t) || (S(t) ? t = t.getTime() : M(t) ? t = t.join(",") : x(t) && (t = JSON.stringify(t)), n && (t = encodeURIComponent(t)), r.push(encodeURIComponent(e) + "=" + t))
        }), r.join(t || ",")
      }
    ...
    (function (t) {
      ...
      var o = function () {
        ...
        return function t(n) {
          var s = e, o = n && "object" === (void 0 === n ? "undefined" : (0, i.default)(n)) && "String" != m(n);
          o && (s = n, n = null);
          ...
          var h, y, v, b, M, T = o ? !!c.likeChrome : /\bChrome\b/.test(n) && !/internal|\n/i.test(a.toString()),
            ...
            C = /\bJava/.test(P) && s.java, O = C && m(s.environment) == k, w = C ? "a" : "α", x = C ? "b" : "β",
          ...
          if (U && (h = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(U) || /(?:alpha|beta)(?: ?\d)?/i.exec(n + ";" + (N && c.appMinorVersion)) || /\bMinefield\b/i.test(n) && "a") && (F = /b/i.test(h) ? "beta" : "alpha", U = U.replace(RegExp(h + "\\+?$"), "") + ("beta" == F ? x : w) + (/\d+\+?/.exec(h) || "")), "Fennec" == L || "Firefox" == L && /\b(?:Android|Firefox OS)\b/.test(H)) L = "Firefox Mobile"; else if ("Maxthon" == L && U) U = U.replace(/\.[\d.]+/, ".x"); else if (/\bXbox\b/i.test(B)) "Xbox 360" == B && (H = null), "Xbox 360" == B && /\bIEMobile\b/.test(n) && j.unshift("mobile mode"); else if (!/^(?:Chrome|IE|Opera)$/.test(L) && (!L || B || /Browser|Mobi/.test(L)) || "Windows CE" != H && !/Mobi/i.test(n)) if ("IE" == L && N) try {
    ...
    var p = m.fn = m.prototype = Object.create(new o), f = function (e) {
    ...
    e.exports = function (e, t, n, f, g, h, y) {
      ...
      var v, b, M, T = function (e) {
        ...
        }, S = t + " Iterator", k = "values" == g, P = !1, I = e.prototype, C = I[m] || I["@@iterator"] || g && I[g],
        O = C || T(g), w = g ? k ? T("entries") : O : void 0, x = "Array" == t && I.entries || C;
      if (x && (M = l(x.call(new e))) !== Object.prototype && M.next && (u(M, S, !0), r || "function" == typeof M[m] || o(M, m, p)), k && C && "values" !== C.name && (P = !0, O = function () {
        return C.call(this)
      }), r && !y || !d && !P && I[m] || o(I, m, O), a[t] = O, a[S] = p, g) if (v = {
        values: k ? O : T("values"),
        keys: h ? O : T("keys"),
        entries: w
    ...
    "use strict";
    var r = n(11), s = n(140), i = n(138), o = n(137), a = {}, c = r.f;
    ...
    var r = n(5), s = {
      genUrlSep: function (e) {
        ...
        var i = e.substr(e.indexOf("?") + 1).split("&"), o = {};
    ...
    "use strict";
    var r = n(11), s = r.getGlobal(), i = {}, o = s.name || "_parent", a = [], c = [];
    ...
    var r = n(28)("meta"), s = n(18), i = n(13), o = n(12).f, a = 0, c = Object.isExtensible || function () {
      return !0
    }, u = !n(20)(function () {
    ...
    var r = n(8), s = n(13), i = n(14), o = n(16), a = n(61), c = n(97).KEY, u = n(20), l = n(41), m = n(34), d = n(28),
      ...
      k = n(48), P = n(94), I = n(57), C = n(12), O = n(29), w = I.f, x = C.f, A = P.f, E = r.Symbol, _ = r.JSON,
      ...
      H = r.QObject, W = !H || !H.prototype || !H.prototype.findChild, J = i && u(function () {
        ...
        return e === B && $(L, t, n), v(e), t = T(t, !0), v(n), s(D, t) ? (n.enumerable ? (s(e, j) && e[j][t] && (e[j][t] = !1), n = k(n, {enumerable: S(0, !1)})) : (s(e, j) || x(e, j, S(1, {})), e[j][t] = !0), J(e, t, n)) : x(e, t, n)
      }, z = function (e, t) {
        v(e);
    ...
    q || (a((E = function () {
      ...
      return this._k
    }), I.f = G, C.f = $, n(58).f = P.f = Q, n(27).f = K, n(37).f = Y, i && !n(35) && a(B, "propertyIsEnumerable", K, !0), f.f = function (e) {
      return V(p(e))
 ...
 */
      ...
      void 0 === root.location && (root.location = null), root.io ? module && (module.exports = io = root.io) : root.io = io, function () {
        !function (e, t) {
          ...
          e.Socket = r, t.util.mixin(r, t.EventEmitter), r.prototype.of = function (e) {
            ...
            var e = this, t = this.options["max reconnection attempts"], n = this.options["try multiple transports"],
          ...
          e.XHR = r, t.util.inherit(r, t.Transport), r.prototype.open = function () {
            ...
            try {
              var s = t.util.request(r), i = n.XDomainRequest && s instanceof XDomainRequest,
                o = e && e.options && e.options.secure ? "https:" : "http:", a = n.location && o != n.location.protocol;
              if (s && (!i || !a)) return !0
            } catch (e) {
            }
            return !1
    ...
    var r = n(0), s = n(80), i = r.merge({}, s.idMap, {
      ...
      updatePushToken: {
        ...
        params: [{type: "String", name: "tokenName"}, {type: "String", name: "token"}, {type: "int", name: "pushkit"}]
      },
      appBackground: {
        sid: i.user.id,
      ...
      addTeamMembers: {
        ...
        params: [{type: "long", name: "teamId"}, {type: "StrArray", name: "accounts"}, {type: "String", name: "ps"}]
      },
      removeTeamMembers: {
        sid: i.team.id,
      ...
      "3_8": {
        service: "user",
        cmd: "getRelations",
        response: [{type: "PropertyArray", name: "specialRelations", entity: "specialRelation"}, {
          type: "Number",
          name: "timetag"
        }]
      },
      ...
      "8_30": {
        ...
        response: [{type: "String", name: "idClient"}, {type: "StrArray", name: "readAccounts"}, {
          type: "StrArray",
          name: "unreadAccounts"
        }]
      },
 ...
 */
      ...
      r = function () {
        ...
        var I = void 0, C = 1, O = 2, w = {error: null};
        ...
        function A(t, n, r) {
          n.constructor === t.constructor && r === T && n.constructor.resolve === S ? function (e, t) {
            t._state === C ? R(e, t._result) : t._state === O ? j(e, t._result) : F(t, void 0, function (t) {
              return E(e, t)
            }, function (t) {
              return j(e, t)
            })
          }(t, n) : r === w ? (j(t, w.error), w.error = null) : void 0 === r ? R(t, n) : e(r) ? function (e, t, n) {
            a(function (e) {
        ...
        function E(e, t) {
          var n, r;
          e === t ? j(e, new TypeError("You cannot resolve a promise with itself")) : (r = typeof(n = t), null === n || "object" !== r && "function" !== r ? R(e, t) : A(e, t, x(t)))
        }
        ...
        function R(e, t) {
          e._state === I && (e._result = t, e._state = C, 0 !== e._subscribers.length && a(N, e))
        }

        function j(e, t) {
          e._state === I && (e._state = O, e._result = t, a(_, e))
        }

        function F(e, t, n, r) {
          var s = e._subscribers, i = s.length;
          e._onerror = null, s[i] = t, s[i + C] = n, s[i + O] = r, 0 === i && e._state && a(N, e)
        }
        ...
        function U(t, n, r, s) {
          ...
          if (i) {
            ...
            }(r, s)) === w ? (u = !0, a = o.error, o.error = null) : c = !0, n === o) return void j(n, new TypeError("A promises callback cannot return that same promise."))
          } else o = s, c = !0;
          n._state !== I || (i && c ? E(n, o) : u ? j(n, a) : t === C ? R(n, o) : t === O && j(n, o))
        }
        ...
        var B = function () {
          ...
          return e.prototype._enumerate = function (e) {
            ...
            var r = this.promise;
            r._state === I && (this._remaining--, e === O ? j(r, n) : this._result[t] = n), 0 === this._remaining && R(r, this._result)
        ...
        var q = function () {
          function e(t) {
            this[k] = D++, this._result = this._state = void 0, this._subscribers = [], P !== t && ("function" != typeof t && function () {
    ...
    e.exports = c, c.XMLHttpRequest = r.XMLHttpRequest || function () {
    ...
    e.exports = {
      ...
      nosToken: {1: "objectName", 2: "token", 3: "bucket", 4: "expireTime", 7: "expireSec", 8: "tag"},
      audioToText: {2: "url"},
      imageOp: {
        0: "type",
        1: "stripmeta",
    ...
    var r = n(0), s = n(80), i = r.merge({}, s.idMap, {
      ...
      updateMyChatroomMemberInfo: {
        ...
        params: [{type: "Property", name: "chatroomMember"}, {type: "bool", name: "needNotify"}, {
          type: "String",
          name: "custom"
    ...
    u.viewImageSync = function (e) {
      ...
      if (t.downloadUrl) {
        ...
        return (0, o.object2url)({protocol: M.protocol, hostname: M.hostname, path: M.path, query: c.merge(M.query, l)})
      }
    ...
    i.transDoc = function (e) {
      ...
      try {
        var t = e.fileInput.files[0], n = e.fileInputName = t.name, r = {ppt: 1, pptx: 2, pdf: 3},
      ...
      var t = e.callback, n = e.nosToken, r = e.responseBody, s = {tag: n.nosScene};
    ...
    "use strict";
    var r = n(0), s = n(25), i = n(51).upload, o = n(51).abort, a = r.supportFormData, c = 104857600;
      ...
      s = [], void 0 === (i = "function" == typeof(r = function (e) {
        return function (t) {
          ...
          function g(e, n, r) {
            ...
            if (t.jsAttributeConverter && (e = t.jsAttributeConverter.call(null, n, e)), null != e && "" !== e || !t.selfClosingElements) if ("object" == typeof e) if ("[object Array]" === Object.prototype.toString.call(e)) s += function (e, t, n) {
              var r = "";
    ...
    o.sendText = function (e) {
      ...
      var t = this, n = e.uploaddone, r = l.genUploadUrl(e.nosToken.bucket), s = this.assembleUploadParams(e.nosToken);
    ...
    o.batchSendEventsCmds = function (e, t, n) {
      var r = this, s = a.dropArrayDuplicates(t.accounts);
      s = a.reshape2d(s, 100);
      var i = [];
    ...
    "use strict";
    var r = n(31).fn, s = n(171), i = n(0), o = i.undef;
    ...
    var m = {text: 0, image: 1, audio: 2, video: 3, geo: 4, notification: 5, file: 6, tip: 10, robot: 11, custom: 100};
    ...
    "use strict";
    var r = n(31).fn, s = n(0), i = s.undef, o = s.notundef;
    ...
    "use strict";
    var r = n(31).fn, s = n(0), i = s.objs2accounts, o = n(131);
    ...
    "use strict";
    var r, s = n(53), i = (r = s) && r.__esModule ? r : {default: r};
    var o = n(24).fn, a = n(0), c = i.default.clientTypeMap;
    ...
    "use strict";
    n(24).fn.processFilter = function (e) {
      switch (e.cmd) {
        case"sendFilterMsg":
          this.onSendMsg(e, !0);
          break;
    ...
    r.onDeleteMsg = function (e) {
      ...
      if (!e.error) {
        var t = this, n = 1 == +e.content.type ? "offline" : "roaming", r = s.reverseSysMsgs(e.content.sysMsgs, {
          mapper: function (e) {
    ...
    r.processMsg = function (e) {
      ...
      var t = this, n = t.message, r = n.Message, s = r.getMaxTimetag, i = n.reverseMsgs(e.content.msgs), o = s(i);
      i = r.sortMsgs(i);
      ...
      if (s.isArray(e) || (e = [e]), e[0].filter) return Promise.resolve(e);
      var n = this, r = n.db, o = r.enable, a = Promise.resolve(), c = n.message.Message.getLastMsg(e), u = c.flow,
        l = c.sessionId !== n.currSessionId, m = n.genSessionByMsgs(e);
      f(m);
      var d = !1, p = [];
      ...
      var t = this, n = t.db, r = "success" === e.status, s = c.genSessionByMsg(e), i = !!e.isLocal;
      return n.enable ? n.updateMsg(e).then(function (e) {
        var o = n.updateSession(s), a = Promise.resolve();
      ...
      var i = this.db, o = t.teamId, c = t.memberUpdateTime, u = {id: a.genId(o, n), type: "normal", updateTime: c},
    ...
    r.processFriend = function (e) {
      ...
      var t, n = this, r = n.db, s = e.error, a = n.packetFromSync(e), c = e.content.friends, u = !0, l = [], m = [],
    ...
    r.processUser = function (e) {
      ...
      var t = this, n = t.db, r = e.error, s = t.packetFromSync(e), a = e.content.specialRelations, c = !0, u = void 0,
        l = [], m = [], d = [], p = [], f = new Promise(function (f, h) {
          var y, v;
    ...
    s(s.S + s.F * !n(132)(function (e) {
      ...
      from: function (e) {
        ...
        if (h && (g = r(g, f > 2 ? arguments[2] : void 0, 2)), null == v || p == Array && a(v)) for (n = new p(t = c(d.length)); t > y; y++) u(n, y, h ? g(d[y], y) : d[y]); else for (m = v.call(d), n = new p; !(s = m.next()).done; y++) u(n, y, h ? o(m, g, [s.value, y], !0) : s.value);
        return n.length = y, n
      }
    })
  }, function (e, t, n) {
    ...
    o.beforeSync = function () {
      ...
      var t, n, r, s, o, f, g, h, y, v, b, M, T, S, k, P, I, C, O, w, x, A, E = this, _ = E.db, R = _.enable,
      ...
      function L() {
        if (F) {
          if (E.logger.info("sync::onSyncDone: after sync", a.promises2cmds(F)), F = [], n = N.blacklist || [], r = N.invalidBlacklist || [], s = N.mutelist || [], o = N.invalidMutelist || [], f = N.friends, g = N.invalidFriends || [], h = N.myInfo, y = N.users, v = N.teams, b = N.invalidTeams || [], M = N.sessions, T = N.msgReceipts, S = N.roamingMsgs, k = N.offlineMsgs, P = N.offlineFilterMsgs, C = N.offlineSysMsgs, O = N.offlineCustomSysMsgs, w = N.offlineFilterSysMsgs, x = N.offlineFilterCustomSysMsgs, N.broadcastMsgs, A = N.sysMsgUnread, M) {
            var e = [];
      ...
      function H() {
        ...
        }), i.length && (I = (I = I || []).concat(i)), o.length && (C = (C = C || []).concat(o)), I && (E.logger.info("sync::notifyDataAsync: on roaming sys msgs", I.length, I), j.onroamingsysmsgs(I)), C && (E.logger.info("sync::notifyDataAsync: on offline sys msgs", C.length, C), j.onofflinesysmsgs(C)), w && (E.logger.info("sync::notifyDataAsync: on offline filter sys msgs", w.length, w), j.onofflinefiltersysmsgs(w)), O && (E.logger.info("sync::notifyDataAsync: on offline custom sys msgs", O.length, O), j.onofflinecustomsysmsgs(O)), x && (E.logger.info("sync::notifyDataAsync: on offline filter custom sys msgs", x.length, x), j.onofflinefiltercustomsysmsgs(x)), A && (A = a.merge({}, E.sysMsgUnread, A), E.sysMsgUnread = a.merge({}, A), E.logger.info("sync::notifyDataAsync: on sysMsgUnread", A), j.onsysmsgunread(A));
    ...
    "use strict";
    var r = n(50).fn, s = n(0), i = s.notundef;
    r.putSession = function (e) {
      ...
      var t = this, n = e.id, r = s.filterObj(e, "ack unread lastMsg localCustom msgReceiptTime msgReceiptServerTime");
    ...
    r.mergeTeams = function (e, t, n) {
      ...
      var r = this, s = e.teamId, i = e.memberUpdateTime, o = {teamId: s, account: t, type: "normal", updateTime: i},
            ...
            var r = this, s = !1, i = !1, o = function (r, o, c, d, p, f, g) {
              return new Promise(function (y, v) {
                var b = s || i ? m : l, M = t.transaction(e, b), T = M.objectStore(e), S = n ? T.index(n) : T,
                  k = r ? u[r].apply(null, o) : null, P = [], I = [k], C = 0;
                p = p || null, f = f || [], "count" !== c && I.push(d || "next");
                var O = !!s && Object.keys(s);
                S[c].apply(S, I).onsuccess = function (e) {
